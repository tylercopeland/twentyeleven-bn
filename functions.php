...
function twentyeleven_setup() {
	...
	register_default_headers( array(
		'bn' => array(
			'url' => '%s/images/headers/bn.jpg',
			'thumbnail_url' => '%s/images/headers/bn-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Blindside Networks', 'twentyeleven' )
		),
		'bnlogo' => array(
			'url' => '%s/images/headers/bnlogo.jpg',
			'thumbnail_url' => '%s/images/headers/bnlogo-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Blindside Networks Logo', 'twentyeleven' )
		)
	) );
}
